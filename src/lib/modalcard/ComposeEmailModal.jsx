...
const ComposeEmailModal = ({
  ...
  const handleAttachFile = () => {
    toast.error("File attachment functionality coming soon!");
    Swal.fire({
      icon: "info",
      title: "Attach File",
  ...
  const handleWarning = () => {
    toast.warning("Ensure the email content is appropriate before sending.");
  };

  const handleAddPicture = () => {
    toast.error("Picture insertion functionality coming soon!");
  };

  const handleLockEmail = () => {
    toast.error("Lock email functionality coming soon!");
  };

  const handleEditOptions = () => {
    toast.error("Edit options functionality coming soon!");
  };
