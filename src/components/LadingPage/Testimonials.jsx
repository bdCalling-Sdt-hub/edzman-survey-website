...
const Testimonial = () => {
  ...
  return (
    <section className="max-w-[90vw] pb-20 pt-20 dark:bg-dark lg:pb-[120px] lg:pt-[120px]">
      <SectionHeader
    ...
    <div className="relative w-full flex justify-center">
      <div className="relative w-[90vw] pb-8 md:w-11/12 lg:w-10/12 xl:w-8/12">
        <div className="w-full flex flex-col items-center md:flex-row">
          <div className="relative mb-8 w-full max-w-[250px]">
            <img src={image} alt="image" className="w-full rounded-lg" />
          </div>
          <div className="w-full text-center ml-4 md:text-left">
            <div>
              <img src={reviewImg} alt={reviewAlt} className="h-6 mx-auto md:mx-0" />
              <p className="mb-4 text-sm italic text-gray-600 dark:text-gray-300">{details}</p>
