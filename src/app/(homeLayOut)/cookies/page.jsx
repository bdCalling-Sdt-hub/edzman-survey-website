      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center my-12">
          <h1 className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-bold">
            <span className="text-[#00b0f2]">FindYourWhy.com</span>Website
            Cookie Policy
          </h1>
          ...
          <p className="mt-4 text-sm sm:text-base leading-relaxed">
            This Cookie Policy explains how FindYourWhy.com ("we", "us", "our")
            uses cookies and similar technologies to enhance your experience
            when you visit our website <span>www.findyourwhy.com</span>{' '}
            ("Website"). By continuing to use our Website, you consent to our
