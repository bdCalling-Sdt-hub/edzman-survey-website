  ...
  const termsData = [
    {
      ...
      description:
        "We may collect various types of personal information when you use our Website or services, including:",
      pointer: [
    ...
    },
    {
      ...
      description:
        "In some jurisdictions, including the European Union, we are required to explain the legal basis for processing personal data. We rely on the following legal bases:",
      pointer: [
...

    {
      ...
      description:
        "As a global business, your personal information may be transferred, stored, and processed outside of your country of residence, including in countries that may have different data protection laws. By using our services, you consent to such transfers, including to countries that may not offer the same level of data protection as your home country.",
    },
    {
      title: "Data Retention ",
      description:
        "We will retain your personal information only for as long as necessary to fulfill the purposes outlined in this Privacy Policy, or as required by law. The retention period may vary depending on the type of information and the purpose for which it was collected.",
    },
    {
    ...
    },
    {
      title: "Security ",
      description:
        "We take reasonable steps to protect your personal information from unauthorized access, use, disclosure, and alteration. However, no method of transmission over the Internet or electronic storage is completely secure. While we strive to protect your personal data, we cannot guarantee its absolute security.",
    },
    {
      title: "Cookies and Tracking Technologies ",
      description:
        "Our Website uses cookies and similar tracking technologies to improve your browsing experience, analyze trends, administer the site, and gather demographic information. You can control the use of cookies at the individual browser level. For more information about cookies, please refer to our [ Cookie Policy ].",
    },
    {
      title: "Children’s Privacy ",
      description:
        "Our Website is not intended for individuals under the age of 13 (or under 16 in the EU), and we do not knowingly collect personal data from children. If we become aware that we have inadvertently collected personal data from a child, we will take steps to delete such data.",
    },
    {
      title: "Contact Us ",
      description:
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center my-12">
          <h1 className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-bold">
            <span className="text-[#00b0f2]">FindYourWhy.com</span>Privacy
            Policy
          </h1>
          ...
          <p className="mt-4 text-sm sm:text-base leading-relaxed">
            FindYourWhy.com ("we", "our", or "us") values your privacy and is
            committed to protecting your personal information. This Privacy
            Policy explains how we collect, use, disclose, and safeguard your
            personal data when you visit our website www.findyourwhy.com ("the
            Website") and use our services. This policy applies to all visitors,
            users, and others who access the Website or use our services,
